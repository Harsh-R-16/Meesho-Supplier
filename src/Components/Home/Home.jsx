...
import { Main, Article, Section } from "./Styled-Home";
import {
  FcAbout,
  FcUndo,
  FcAreaChart,
    ...
    <>
      <Main>
        <nav>
          ...
          <div>
            <p onClick={() => setInd(1)}>Sell Online</p>
            <p onClick={() => setInd(2)}>How it Works</p>
            <p onClick={() => setInd(3)}>Pricing &amp; Commision</p>
      ...
      <img src={numimg} alt="" />
      <Section id="data">
        <h1>Why Suppliers Love Meesho</h1>
        <p>
          All the benefits that come with selling on Meesho are designed to help
          you sell more, and make it easier to grow your business.
        </p>
        <article id="grid-view">
          <div>
            <h2>
              0% Commission Fee
              <FcAbout />
          ...
          <div>
            ...
            <p>From small to large and unbranded to branded</p>
            <p>all suppliers have grown their businesses on Meesho</p>
          </div>
          <div>
            <h2>
            ...
            <p>tick Easy Product Listing </p>
            <p>tick Lowest Cost Shipping</p>
            <p> tick 7-Day Payment Cycle from the delivery date</p>
          </div>
        </article>
        <h1>Exclusive Supplier+ Rewards for the first 30 days</h1>
        <article id="grid-view">
          <div>
            <h2>
          ...
          <div>
            ...
            <p>
              Send out your orders stress-free with zero fees on return shipping
              for the first month
            </p>
          </div>
          <div>
            ...
            <p>
              Cancel orders that you can’t fulfil for unforeseen reasons without
              worrying about penalties”
            </p>
          </div>
        </article>

        <h1>Experiences suppliers love to talk about</h1>
        <article id="grid-view">
          <div>
            <h2>
              Saurabh Anand
          ...
          <div>
            ...
            <p>
              ...
              what to sell and at what price to sell. I don't get that anywhere
              else.
            </p>
          </div>
          <div>
        ...
        <article id="grid-view">
          <div>
            ...
            <p>
              Sell your products across India to over 27,000+ pincodes at lowest
              delivery cost.
            </p>
          </div>
          <div>
            ...
            <p>
              Use Meesho’s selling tools like ads to be more visible and sell
              more products
            </p>
          </div>
          <div>
